...
const MoodCard = () => {
  const photos = [
    ...
    },
    {
      ...
      list:
        "1. Find the Sun - Bright light can help lift your spirits and potentially put you in a cheery mood. ",
      list2:
        "2. Give Yourself a Hand Massage - Your hands can carry a lot of tension. Knead the base muscle under your thumb, this will help ease stress in the shoulders, neck & scalp.",
      list3: "3.  - ",
      list4: "4.  - ",
      list5:
    ...
    },
    {
      ...
      list2:
        "2. Bilateral stimulation, or side-to-side stimulation, is a technique used in EMDR therapy that can help to induce a relaxation response. Sophia V., 26, who has OCD and anxiety, says she’s had success by tapping her hands on opposite shoulders in an alternating pattern. You can tap alternate arms or legs as well.",
      list3: "3.  - ",
      list4: "4.  - ",
      list5: "5.  - ",
